...
//            oldDoFilter(request, response, chain);
//        }else{
//            chain.doFilter(request, response);
//        }
//    }
//
//    private void oldDoFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
